...
# Default layout: app/ package per standards/project-structures/python-fastapi.md
...
# Application code — matches standards/project-structures/python-fastapi.md layout (app/ package)
...
# Uvicorn: default assumes app/main.py defines `app`. Adjust module path if different.
